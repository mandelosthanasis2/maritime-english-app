          ...
          <div key={lesson.lesson_id} className="admin-teach-row">
            ...
            {lesson.track !== 'email' && (
              <LessonItemsManager
                ...
                onError={(msg) => setNotes((n) => ({ ...n, [lesson.lesson_id]: msg }))}
                onNotice={(msg) => setNotes((n) => ({ ...n, [lesson.lesson_id]: msg }))}
              />
            )}
          </div>
        ))}
...
function LessonItemsManager({ lessonId, skillArea, onError, onNotice }) {
